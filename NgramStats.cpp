...
static char NgramStats_RcsId[] = "@(#)$Header: /home/srilm/CVS/srilm/lm/src/NgramStats.cc,v 1.66 2012/10/29 17:25:04 mcintyre Exp $";
#endif
...
//    if (offset < 0) {
//	file.position() << ts_strerror(errno) << endl;
//	return false;
//    }
//
//    /* 
...
//		file.offset() << ts_strerror(errno) << endl;
//		return false;
//	    }
//	    offset = endOffset;
//	} else {
    ...
    Boolean sorted)		/* produce sorted output */
{
    ...
    // QIN: This is very wrong, where's maxLineLength? Should be the buffer size, but seems no one calls it
